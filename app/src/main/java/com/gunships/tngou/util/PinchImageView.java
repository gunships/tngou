 ...
 */
    ...
    public class PinchImageView extends ImageView  {
        ...
        public boolean dispatchTouchEvent(MotionEvent ev) {
            int originalWidth =getImageOriginalSize();
            getParent().requestDisallowInterceptTouchEvent(true);
            switch (ev.getAction()){
                case MotionEvent.ACTION_DOWN:
                case MotionEvent.ACTION_MOVE:
                    if(originalWidth>1080||originalWidth<1000){
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }else {
        ...
        public int getImageOriginalSize(){
            ...
            float sx = values[0];
            float sy = values[4];
            int cw = (int)(dWidth*sx);
            int ch = (int)(dHeight*sy);
            return cw;
        }
        /**
         * 图片缩放动画时间
