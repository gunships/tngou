...
public class AutoLoadRecyclerView extends RecyclerView implements LoadFinishCallBack{
     ...
     * @param pauseOnFling
     */
    public void setOnPauseListenerParams(com.nostra13.universalimageloader.core.ImageLoader imageLoader, boolean pauseOnScroll, boolean pauseOnFling) {
    ...
    private class AutoLoadScrollListener extends OnScrollListener {
        ...
        public AutoLoadScrollListener(com.nostra13.universalimageloader.core.ImageLoader imageLoader, boolean pauseOnScroll, boolean pauseOnFling) {
            super();
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            if (imageLoader != null) {
                switch (newState) {
                    case 0:
                        Log.i("1111111111111111111","111111111111111111111111");
                        imageLoader.resume();
                        break;

                    case 1:
                        Log.i("2222222222222222222222","22222222222222222222");
                        if (pauseOnScroll) {
                            imageLoader.pause();
                        } else {
                            imageLoader.resume();
                    ...
                    case 2:
                        Log.i("33333333333333333","33333333333333333333333");
                        if (pauseOnFling) {
                            imageLoader.pause();
                        } else {
                            imageLoader.resume();
